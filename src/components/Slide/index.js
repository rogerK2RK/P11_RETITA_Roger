...
function Slide({ imgList }) {
  ...
  return (
    <div className={styles["box-slide"]}>
      <img
        className={styles["image-logement"]}
        src={imgList[activeIdx]}
        alt="Pictur of logements"
      />
      ...
      {imgList.length > 1 && (
        <>
          <img
            ...
            className={styles["bt-next"]}
            src={next}
            alt="button next"
          />
          <img
            onClick={gotToPrevPicture}
            className={styles["bt-prev"]}
            src={prev}
            alt="button prev"
          />
        </>
